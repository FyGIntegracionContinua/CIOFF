...
public interface Parser {
	 ...
	 */
	static final String E_WEB_CHEQUES_GRAL		= "E.CLIENTES.GRAL.CHEQUES";  //Informaciun cheques web
	/**
	 * E_WEB_CHEQUES_INFO String
	 */
	static final String E_WEB_CHEQUES_INFO		= "E.CLIENTES.INFO.CHEQUES";  //Informaciun clientes cheques web
	...
	static final String ID 					= "ID";
 	 ...
 	 */
 	static final int WEB_CHEQUES_GRAL   	= 1012;	//Cheques web, informaciun general
 	/**
 	 * WEB_CHEQUES_CLIENTES int
 	 */
 	static final int WEB_CHEQUES_CLIENTES	= 1013; //Cheques web, informaciun clientes
 	/**
 	 * PETICION_OFS String
 	 */
