...
public class MapperSalidaImpl implements MapperSalida {
	...
	private String normalizaCaracetresEspeciales( String desnormalizada ) {
		...
		normalizada  = normalizada.replace("?", "//06");
		normalizada  = normalizada.replace("?", "//07");
		normalizada  = normalizada.replace("?", "//08");
		normalizada  = normalizada.replace("?", "//09");
		normalizada  = normalizada.replace("?", "//10");
		normalizada  = normalizada.replace("?", "//11");
		normalizada  = normalizada.replace("?", "//12");
		normalizada  = normalizada.replace("?", "//13");
		normalizada  = normalizada.replace("?", "//14");
		normalizada  = normalizada.replace("?", "//15");
		normalizada  = normalizada.replace("?", "//16");
		normalizada  = normalizada.replace("?", "//17");
		normalizada  = normalizada.replace("?", "//18");
		normalizada  = normalizada.replace("?", "//19");
		normalizada  = normalizada.replace("?", "//20");
		normalizada  = normalizada.replace("?", "//21");
		normalizada  = normalizada.replace("?", "//22");
		normalizada  = normalizada.replace("?", "//23");
		normalizada  = normalizada.replace("?", "//24");
		normalizada  = normalizada.replace("?", "//25");
		normalizada  = normalizada.replace("?", "//26");
		normalizada  = normalizada.replace("?", "//27");
		normalizada  = normalizada.replace("?", "//28");
		normalizada  = normalizada.replace("?", "//29");
		normalizada  = normalizada.replace("?", "//30");
		normalizada  = normalizada.replace("?", "//31");
		normalizada  = normalizada.replace("?", "//32");
		normalizada  = normalizada.replace("?", "//33");
		normalizada  = normalizada.replace("?", "//34");
		normalizada  = normalizada.replace("?", "//35");
		normalizada  = normalizada.replace("?", "//36");
		normalizada  = normalizada.replace("?", "//37");
		normalizada  = normalizada.replace("?", "//38");
	...
	public  String generaRespuesta( String uid, ObjetoValor respuestaOV ) {
		...
		switch (  tipo ) {
			case Parser.ALTA_CLIENTE  :
				...
				encabezado.setMensaje( clienteSResp.getMensaje() );
				break;
